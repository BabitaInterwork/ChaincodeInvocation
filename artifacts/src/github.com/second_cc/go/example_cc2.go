...
// calling one chaincode from onother
func (t *SimpleChaincode) called(stub shim.ChaincodeStubInterface, args []string) pb.Response {



logger.Infof("##############################  Called By Chaincode - example_cc.go #################################")
